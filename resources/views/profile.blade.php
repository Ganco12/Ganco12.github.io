...
<div class="top-navigation">
    ...
    <div class="main-wrapper">
        ...
        <div class="user-info">
            ...
            <div class="nick">ДОБРО ПОЖАЛОВАТЬ, <span>{{Auth::user()->username}}</span></div>

        </div>
        <div class="box">
            <label for="steam-id">Ваш Id</label>
            <div class="group-input">
                <input type="text" id="steam-id" readonly value="{{Auth::user()->steamid}}"> <button id="steam-id-copy">скоп.</button>
            </div>
        </div>
        <div class="stats">
            <div class="stats-won">
                <div class="label">Выиграл</div>
                <div class="value">{{Auth::user()->total_won}}</div>
            </div>
            <div class="stats-lost">
                <div class="label">Проиграл</div>
