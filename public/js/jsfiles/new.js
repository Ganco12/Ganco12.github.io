...
var RANK = 0;
var ROUND = 0;
var HOST = "localhost:8080"; // Edit this to your own IP or domain and port. Check the readme.txt for CloudFlare ports.
var SOCKET = null;
var showbets = true;
var carnat = null;
var betplaced;
...
function connect() {
	...
	function crUpdateHistory() {
	   $("#crHist").load("http://ullubiygaming.com/crash/getCRHistory.php");
